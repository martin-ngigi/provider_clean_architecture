...
import 'package:provider_clean_architecture/core/constants/constants.dart';
import 'package:provider_clean_architecture/features/pokemon/business/entities/pokemon_entity.dart';
  ...
  void eitherFailureOrPokemonImage({required PokemonEntity pokemonEntity}) async {
    ...
    failureOrPokemonImage.fold(
      ...
      (PokemonImageEntity pokemonImageEntity) {
        pokemonImage = pokemonImageEntity;
        failure = null;
        notifyListeners();
      },
    );
