...
class PokemonImageRemoteDataSourceImpl implements PokemonImageRemoteDataSource {
  ...
  Future<PokemonImageModel> getPokemonImage({required PokemonImageParams pokemonImageParams}) async {
    ...
    Directory directory = await getApplicationDocumentsDirectory(); /// import path_provider
    directory.deleteSync(recursive: true); /// delete all files already saved on phone directory. Set recursive: true sincce dir isn't empty
